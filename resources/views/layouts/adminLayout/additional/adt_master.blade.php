...
$(document).ready(function() {
    ...
    $("#current_pwd").keyup(function() {
        var inCorect = "<span class='badge badge' style='background-color: firebrick;position: static;'>{{__('validation.passIncorect')}}</span>"
        var isCorect = "<span class='badge badge-success' style='position: static;'>{{__('validation.passIscorrect')}}</span>"
