...
@section('title')
Edit User Admin | Admin Hsn E-commerce
@endsection
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> {{__('backend.home')}}</a> <a href="{{ $module->permalink }}">User Admin</a>
     <a href="{{ $module->permalink.'/edit' }}" class="current">Edit User Admin</a> </div> 
    <h1> User Admin </h1> 
  </div>
          ...
          <form class="form-horizontal" action="{{ $module->permalink.'/update' }}" id="form-data" method="post" autocomplete="off">
            @csrf
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="username" class="form-control" value="{{ old('username') ?: $data_edit->name }}" style=" @error('username') border-style: solid; border-color: orangered; @enderror ">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="email" name="email" class="form-control" value="{{ old('email') ?: $data_edit->email }}" style=" @error('email') border-style: solid; border-color: orangered; @enderror ">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" name="phone" class="form-control" value="{{ old('phone') ?: $data_edit->mobile }}" style=" @error('phone') border-style: solid; border-color: orangered; @enderror ">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    @if(session('sesssion_guid') == 1)
                    <select class="select2" name="user_group" data-minimum-results-for-search="-1" data-placeholder="Select a group" id="">
                ...
                <div class="control-group">
                    <div class="controls">
                        <label class="control-input-content"> Active 
                            <div class="switch">
                                <input type="checkbox" name="active" class="toggle-switch-checkbox toggle-switch-primary" {{ old('active') || $data_edit->status == 1 ? 'checked' : '' }} >
