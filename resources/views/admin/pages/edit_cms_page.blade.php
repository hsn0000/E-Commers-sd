...
@section('title')
Edit CMS Page | Admin Hsn E-commerce
@endsection 
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> {{__('backend.home')}}</a> <a href="{{$module->permalink}}">{{__('backend.cms_pages')}}</a>
     <a href="#" class="current">{{__('backend.edit_cms_page')}}</a> </div> 
            ...
            <form class="form-horizontal" action="{{ $module->permalink.'/add' }}" id="form-table" method="post" autocomplete="off" novalidate="novalidate" enctype="multipart/form-data" >
              ...
              <div class="widget-content nopadding">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="title" @error('title') id="is-invalid-title"  @enderror value="{{old('title') ?? $cmsPage->title}}" >
                      @error('title')
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="url" @error('url') id="is-invalid-url"  @enderror value="{{old('url') ?? $cmsPage->url }}"  >
                      @error('url')
                            <span class="invalid-feedback" role="alert">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <textarea name="description" id="description" style="opcity: 0;" style=" @error('description') border-style: solid; border-color: orangered; @enderror "> {{ old('description') ?? $cmsPage->description }} </textarea>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="meta_title" value="{{old('meta_title') ?? $cmsPage->meta_title}}" >
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">Meta Description</label>
                    <div class="controls">
                      <input type="text" name="meta_description" value="{{old('meta_description') ?? $cmsPage->meta_description }}" >
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">Meta Keywords</label>
                    <div class="controls">
                      <input type="text" name="meta_keywords" value="{{old('meta_keywords') ?? $cmsPage->meta_keywords }}" >
                    </div>
                  </div>
                    ...
                    <div class="control-group">
                      <div class="controls">
                        <label class="control-input-content"> {{__('backend.enable')}} 
                              <div class="switch">
                                  <input type="checkbox" name="status" id="status" value="1" class="toggle-switch-checkbox toggle-switch-primary" @if($cmsPage->status == 1) checked @endif>
