...
@section('title')
Add Billboard | Admin Hsn E-commerce
@endsection
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> {{__('backend.home')}}</a> <a href="#"> {{__('backend.billboards')}}</a>
     <a href="{{url('/admin/add-banner')}}" class="current">{{__('backend.add_billboard')}}</a> </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>{{__('backend.add_billboard')}}</h5>
          </div>
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{url('/admin/add-billboard')}}" name="add_billboard" id="add_billboard">
            {{csrf_field()}}
            <div class="control-group">
              ...
              <div class="form-actions">
                <input type="submit" value="{{__('backend.add_billboard')}}" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
