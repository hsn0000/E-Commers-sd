...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{url('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>{{__('backend.home')}}</a> <a href="#">{{__('backend.banners')}}</a>
     <a href="{{url('/admin/add-banner')}}" class="current">{{__('backend.edit_banners')}}</a> </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>{{__('backend.edit_banners')}}</h5>
          </div>
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{url('/admin/edit-banner/'.$bannerDetails->id)}}" name="edit_banner" id="edit_banner">
            {{csrf_field()}}
            <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <img src="{{ asset('images/backend_images/banners/'.$bannerDetails->image) }}" alt="{{__('backend.old_image')}}" width="220px">
              ...
              <div class="form-actions">
                <input type="submit" value="{{__('backend.edit_banners')}}" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
