            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td style="text-align:center;">@if($banner->status == "1") <span style="color:green">Active</span> @else <span style="color:red">InActive</span> @endif</td>
                  <td style="text-align:center;" width="25%" >
                   @if(!empty($banner->image))
                     <img src="{{ asset('images/backend_images/banners/'.$banner->image )}}" alt="image product" >
                   @endif
                  </td>
                  <td class="center" style="text-align:center;" width="14%;">
                    <a href="{{url('/admin/edit-banner/'.$banner->id)}} " class="btn btn-warning btn-mini" style="margin:35px 0 0 10px;" title="Edit Banner"> <i class="icon-cogs" style="padding:0 4px"></i> Edit</a> 
                    <a rel="{{$banner->id}}" rel1="delete-banner" rel2="{{$banner->title}}" href="javascript:" class="deleteProd btn btn-danger btn-mini" data-del-id="{{$banner->id}}" style="margin:35px 0 0 10px;" title="Delete Banner"> 
