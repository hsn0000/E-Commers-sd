                ...
                <tbody>
                    ...
                    <tr>
                        <td class="cart_product">
                            <a href=""><img style="width:200px;" src="{{ asset('images/backend_images/products/medium/'.$cart->image) }}"" alt=""></a>
                        </td>
							...
							<td colspan="2">
								<table class="table table-condensed total-result">
                                    ...
                                    <tr class="shipping-cost">
                                        ...
                                        <td>@if (!empty(Session::get('CouponAmount'))) Rp.{{Session::get('CouponAmount')}} @else Rp.0 @endif</td>
                                    </tr>
									<tr>
										<td>Grand Total</td>
										<td><span>{{'Rp.'.($grant_total = $total_amount - Session::get('CouponAmount'))}}</span></td>
									</tr>
								</table>
							</td>
						</tr>
