                    ...
                    <tr>
                        ...
                        <td class="cart_quantity">
                            <div class="cart_quantity_button">
                                <a class="cart_quantity_up" href="javascript:" onclick='cartQuantityUpDown({{ "' $cart->id.1 '" }}) '> + </a>
                                <input class="cart_quantity_input" type="text" name="quantity" value="{{$cart->quantity}}" autocomplete="off" size="2">
                                @if($cart->quantity > 1)
                                <a class="cart_quantity_down" href="javascript:" onclick='cartQuantityUpDown({{ "' $cart->id.0 '" }})'> - </a>
                                @endif
                            </div>
                        </td>
                        <td class="cart_total">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="chose_area">
                        ...
                        <form action="javascript:void(0)" id="form-apply-coupon" method="post" enctype="multipart/form-data" > {{csrf_field()}} 
                            <li>
                                <label>Use Coupon Code</label> 
                                <input type="text" name="coupon_code" id="coupon_code" >
                                <input type="submit" value="Apply" class="btn btn-warning" style="width:20%;" onclick="applyCouponFron()">
                            </li>
                            </form>
                        </ul>             
                    </div>
...
function applyCouponFron(e) {
    ...
    if (valueText == '') {
            ...
            /*end valid extention*/ 
        var form = document.forms.namedItem("form-apply-coupon"); // high importance!, here you need change "yourformname" with the name of your form
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    if(data.couponNotExists == 'couponNotExists') {
                        ...
                        var checkoutHtml = " <li> Sub Total <span> "+subTotal+" </span></li> <li>Coupon Discoun <span> "+couponDiscount+" </span></li> <li> Grand Total <span class='btn btn-secondary' data-toggle='tooltip' data-html='true' title='"+grandTotal+"' > "+grandTotal+" </span></li>"
